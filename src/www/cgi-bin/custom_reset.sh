...
<style>
body{font-family:-apple-system,system-ui,sans-serif;background:linear-gradient(135deg,#f97373,#fb923c)}
.card{background:#fff;border-radius:16px;max-width:520px;width:100%;padding:32px;box-shadow:0 18px 45p}
h1{margin:0 0 12px;font-size:22px;color:#b91c1c}
p{margin:6px 0;color:#4b5563;font-size:14px}
.step{margin-top:18px;padding:12px 14px;border-radius:8px;background:#f9fafb;border-left:4px solid #f9}
.btn{display:inline-block;margin-top:22px;padding:10px 20px;border-radius:8px;background:#111827;color}
